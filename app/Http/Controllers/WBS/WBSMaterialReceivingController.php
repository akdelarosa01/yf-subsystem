    ...
    **/
    ...
    private function getInvoiceData($invoiceno)
    {
        ...
        if ($this->CheckInvoiceNo($invoiceno) > 0) {
            ...
            if (count($mr_data) > 0) {
                ...
                $summary = $this->getSummary($mr_data->invoice_no);
                return $data = [
                    'invoicedata' => $invoice,
                    'detailsdata' => $details,
                    'summarydata' => $summary,
    ...
    public function getWBSMRsearch(Request $req)
    {
        ...
        # Create Receive Date Condition.
            ...
            {
                $palletno_cond = " AND pallet_no = '" . $palletno . "'";
            }
    ...
    private function saveToBatch($receivingno,$invoiceno,$item,$qty,$package,$package_qty,$lotno,$supplier,$not_req,$iqc_status,$for_kitting,$received_date,$exp_date)
    {
