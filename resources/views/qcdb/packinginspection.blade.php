                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered table-striped" id="packingdatatable" style="font-size: 10px">
                                                        <thead>
                                                            <tr>
                                                                <td width="2.25%" class="table-checkbox">
                                                                    <input type="checkbox" class="group-checkable checkAllitems" />
                                                                </td>
                                                                <td width="4.25%"></td>
                                                                <td width="6.25%">Date Inspected</td>
                                                                <td width="6.25%">Shipment Date</td>
                                                                <td width="13.25%">Series Name</td>
                                                                <td width="8.25%">P.O. #</td>
                                                                <td width="5.25%">Packing Operator</td>
                                                                <td width="5.25%">Inspector</td>
                                                                <td width="6.25%">Packing Type</td>
                                                                <td width="6.25%">Unit Condition</td>
                                                                <td width="6.25%">Packing Code(per Series)</td>
                                                                <td width="6.25%">Carton #</td>
                                                                <td width="6.25%">Packing Code</td>
                                                                <td width="3.25%">Qty</td>
                                                                <td width="6.25%">Judgement</td>
                                                                <td width="6.25%">Remarks</td>
                                                            </tr>
                                                        </thead>
            ...
            <div class="modal-content ">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="javascript:rc_save();" class="btn btn-success" id="btn_save_runcard">Save</button>
