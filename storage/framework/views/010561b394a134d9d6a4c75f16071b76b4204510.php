...
<?php $__env->startPush('script'); ?>
	<script type="text/javascript">
		...
		$('.pmr_wmi_report').on('click',function(){
			...
			if (mode == 'wmi') {
				var url = "<?php echo e(url('/wbsreportwmireport?datefrom=')); ?>" + datefrom + "&dateto=" + dateto+ "&pono=" + pono+ "&ctrlno=" + issno+ "&item=" + item+ "&mode="+mode;
			} else {
				var url = "<?php echo e(url('/wbsreportpmrreport?datefrom=')); ?>" + datefrom + "&dateto=" + dateto+ "&pono=" + pono+ "&ctrlno=" + issno+ "&item=" + item+ "&mode="+mode;
			}
