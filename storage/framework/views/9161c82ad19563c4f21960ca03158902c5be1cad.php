                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_3" style="font-size:13px">
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td style="width: 5%">           
                                                          <button type="button" name="edit-task" class="btn btn-sm btn-primary edit-task" value="<?php echo e($rec->id . '|' . $rec->pono . '|' .$rec->poqty. '|' .$rec->device. '|' . $rec->series . '|' .$rec->family. '|' .$rec->toutput. '|' . $rec->treject . '|' .$rec->twoyield); ?>" id="editTask<?php echo e($rec->id); ?>">
                                                       ...
                                                       <td><?php echo e(round($twoyield,2)); ?></td>
                                                  </tr>
                                                  <?php endforeach; ?>
                                             </tbody>
                                        </table>
                              ...
                              <div class="col-sm-12">
                                   <div class="scroller" id="tableforporeg" style="height: 300px">
                                        <table id="poreg-table" class="table table-striped table-bordered table-hover"style="font-size:13px">
                                             ...
                                             <?php foreach($tableporeg as $rec): ?>
                                                  <tr>
                                                       <td style="width: 2%" >
                                                            <input type="checkbox" class="form-control input-sm checkboxespo" value="<?php echo e($rec->id); ?>" name="checkitempo" id="checkitempo"></input> 
                                                       </td> 
                                                       <td style="width: 2%">
                                                            <button type="button" name="edit-poreg" class="btn btn-sm btn-primary edit-poreg" value="<?php echo e($rec->id); ?>">
                                                                 <i class="fa fa-edit"></i> 
                                                            </button> 
                                                       </td>                  
                                                       <td><a id="edit-poreg" name="edit-poreg" value="<?php echo e($rec->id); ?>"><?php echo e($rec->pono); ?></a>
                                                       </td>
                                                       <td><?php echo e($rec->device); ?></td>
                                                       <td><?php echo e($rec->poqty); ?></td>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control select2me input-sm" id="devicefamily" name="devicefamily" tabindex="3">
                                                       <option value=""></option>
                                                       <?php foreach($family as $ys): ?>
                                                            <option value="<?php echo e($ys->family); ?>"><?php echo e($ys->family); ?></option>
                                                       <?php endforeach; ?>    
                                                 </Select>
                              ...
                              <div class="col-sm-12">
                                   <div class="scroller" style="height: 300px" id="tablefordevicereg">
                                        <table id="devicereg-table" class="table table-striped table-bordered table-hover"style="font-size:13px">
                                             ...
                                             <?php foreach($tabledevicereg as $rec): ?>
                                                  <tr>
                                                       <td style="width: 2%">
                                                            <input type="checkbox" class="form-control input-sm checkboxesdevice" value="<?php echo e($rec->id); ?>" name="checkitemdevice" id="checkitemdevice"></input> 
                                                       </td>
                                                       <td style="width: 2%">
                                                            <button type="button" name="edit-devicereg" class="btn btn-sm btn-primary edit-devicereg" value="<?php echo e($rec->id); ?>">
                                                                 <i class="fa fa-edit"></i> 
                                                            </button> 
                                                       </td>    
                                                       <td><?php echo e($rec->pono); ?></td>                           
                                                       <td><?php echo e($rec->devicename); ?></td>
                                                       <td><?php echo e($rec->family); ?></td>
                                                       <td><?php echo e($rec->series); ?></td>
                                                       <td><?php echo e($rec->ptype); ?></td>
                                                  </tr>
                                             <?php endforeach; ?>
                                             </tbody>
                                        </table>
                              ...
                              <div class="col-sm-12">
                                   <div class="scroller" style="height: 300px" id="tableforseriesreg">
                                        <table id="seriesreg-table" class="table table-striped table-bordered table-hover"style="font-size:13px">
                                             ...
                                             <?php foreach($tableseriesreg as $rec): ?>
                                                  <tr>
                                                       <td style="width: 2%">
                                                            <input type="checkbox" class="form-control input-sm checkboxesseries" value="<?php echo e($rec->id); ?>" name="checkitemseries" id="checkitemseries"></input> 
                                                       </td>  
                                                       <td style="width: 2%">
                                                            <button type="button" name="edit-seriesreg" class="btn btn-sm btn-primary edit-seriesreg" value="<?php echo e($rec->id); ?>">
                                                                 <i class="fa fa-edit"></i> 
                                                            </button> 
                                                       </td>                             
                                                       <td><?php echo e($rec->family); ?></td>
                              ...
                              <div class="col-sm-12">
                                   <div class="scroller" style="height: 300px" id="tableformodreg">
                                        <table id="modreg-table" class="table table-striped table-bordered table-hover"style="font-size:13px">
                                             ...
                                             <?php foreach($tablemodreg as $rec): ?>
                                                  <tr>
                                                       <td style="width: 2%">
                                                            <input type="checkbox" class="form-control input-sm checkboxesmod" value="<?php echo e($rec->id); ?>" name="checkitemmod" id="checkitemmod"></input> 
                                                       </td> 
                                                       <td style="width: 2%">
                                                            <button type="button" name="edit-modreg" class="btn btn-sm btn-primary edit-modreg" value="<?php echo e($rec->id); ?>">
                                                                 <i class="fa fa-edit"></i> 
                                                            </button> 
                                                       </td>                              
                                                       <td><?php echo e($rec->family); ?></td>     
                              ...
                              <div class="col-sm-12">
                                   <div class="scroller" style="height: 300px" id="tablefortargetreg">
                                        <table id="modreg-table" class="table table-striped table-bordered table-hover"style="font-size:13px">
                                             ...
                                             <?php foreach($target as $rec): ?>
                                                  <tr>
                                                       <td style="width: 2%">
                                                            <input type="checkbox" class="form-control input-sm checkboxestarget" value="<?php echo e($rec->id); ?>" name="checkitemtarget" id="checkitemtarget"></input> 
                                                       </td> 
                                                       <td style="width: 2%">
                                                            <button type="button" name="edit-targetreg" class="btn btn-sm btn-primary edit-targetreg" value="<?php echo e($rec->id); ?>">
                                                                 <i class="fa fa-edit"></i> 
                                                            </button> 
                                                       </td>
                                                       <td><?php echo e($rec->datefrom); ?></td>
                                                       <td><?php echo e($rec->dateto); ?></td>
                                                       <td><?php echo e($rec->yield); ?></td>
                                                       <td><?php echo e($rec->dppm); ?></td>
                                                       <td><?php echo e($rec->ptype); ?></td>
                                                  </tr>
                                             <?php endforeach; ?>
                                             </tbody>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control input-sm " id="ypsr-family" name="ypsr-family">
                                                       ...
                                                       <option value="<?php echo e($fam->family); ?>"><?php echo e($fam->family); ?></option>
                                                       <?php endforeach; ?>
                                                 </Select>
                                             </div>
                                        </div>
...
$(document).ready(function(e) {
     ...
     $('#devicefamily').on('change',function(){
          ...
          $('#deviceseries').html("");
          $.post("<?php echo e(url('/devreg_get_series')); ?>",
          {
...
function poregistration(){
     ...
     $('#tblforporeg').html("");
     $.post("<?php echo e(url('/add-poregistration')); ?>",
     {
          _token:$('meta[name=csrf-token]').attr('content'),
          pono:pono,
          podevice:podevice,
          ...
          if(data >  0){
               ...
               $.post("<?php echo e(url('/display-poregistration')); ?>",
               {
                    _token:$('meta[name=csrf-token]').attr('content'),
               }).done(function(data, textStatus, jqXHR){
                    console.log(data);
...
function deviceregistration(){
     ...
     $('#tblfordevreg').html("");
     $.post("<?php echo e(url('/add-deviceregistration')); ?>",
     {
          _token:$('meta[name=csrf-token]').attr('content'),
          ...
          if(data > 0){
               $('#messageModal').modal('show');
               $('#message').html("Record exist please try another P.O number.");
               $.post("<?php echo e(url('/display-deviceregistration')); ?>",
               {
                    _token:$('meta[name=csrf-token]').attr('content'),
               }).done(function(data, textStatus, jqXHR){
                    console.log(data); 
                    $.each(data,function(i,val){
                         ...
                         $('.edit-devicereg').click(function(){
                              ...
                              $.ajax({
                                   url: "<?php echo e(url('/editdevicereg')); ?>",
                                   method: 'get',
                                   data:  { 
                                        editsearch : editsearch, 
                                   },
...
function seriesregistration(){
     ...
     $('#tblforseries').html("");
     $.post("<?php echo e(url('/add-seriesregistration')); ?>",
     {
          _token:$('meta[name=csrf-token]').attr('content'),
          family:seriesfamily,
          series:seriesname,
          ...
          $.each(data,function(i,val){
               ...
               $('.edit-seriesreg').click(function(){
                    ...
                    $.ajax({
                         url: "<?php echo e(url('/editseriesreg')); ?>",
                         method: 'get',
                         data:  { 
                              editsearch : editsearch, 
                         },
...
function modregistration(){
     ...
     $('#tblformodreg').html("");
     $.post("<?php echo e(url('/add-modregistration')); ?>",
     {
          _token:$('meta[name=csrf-token]').attr('content'),
          mod:mod,
          family:family,
...
function targetregistration(){
     ...
     $('#tblfortarget').html("");
     $.post("<?php echo e(url('/add-targetreg')); ?>",
     {
          _token:$('meta[name=csrf-token]').attr('content'),
          datefrom:datefrom,
          dateto:dateto,
          ...
          $.each(data,function(i,val){
               ...
               $('.edit-targetreg').click(function(){
                    ...
                    $.ajax({
                         url: "<?php echo e(url('/edittargetreg')); ?>",
                         method: 'get',
                         data:  { 
                              editsearch : editsearch, 
                         },
...
function deleteAllcheckeditems(){
     ...
     $.ajax({
          url: "<?php echo e(url('/deleteAll-yieldperformance')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
          ...
          console.log(data);
          window.location.href = "<?php echo e(url('/yieldperformance')); ?>";   
     }).fail(function(jqXHR, textStatus, errorThrown) {
          console.log(errorThrown+'|'+textStatus);
     });
}
function removeporeg(){
     ...
     $('#tblforporeg').html("");
     $.ajax({
          url: "<?php echo e(url('/deleteAllporeg')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
...
function removedevicereg(){
     ...
     $('#tblfordevreg').html("");
     $.ajax({
          url: "<?php echo e(url('/deleteAlldevicereg')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
...
function removeseriesreg(){
     ...
     $('#tblforseries').html("");
     $.ajax({
          url: "<?php echo e(url('/deleteAllseriesreg')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
...
function removemodreg(){
     ...
     $('#tblformodreg').html("");
     $.ajax({
          url: "<?php echo e(url('/deleteAllmodreg')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
...
function removetargetreg(){
     ...
     $('#tblfortarget').html("");
     $.ajax({
          url: "<?php echo e(url('/deleteAlltargetreg')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
...
function update(){
     ...
     $.post("<?php echo e(url('/update-yieldsummary')); ?>",
     { 
          _token: $('meta[name=csrf-token]').attr('content')
          , data: myData
     }).done(function(data, textStatus, jqXHR){
...
function summaryREpt(){
     ...
     window.location = "<?php echo e(url('/summaryREpt')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&srprodtype=" + srprodtype;
}
...
/*function summaryREptpdf(){
     ...
     window.location = "<?php echo e(url('/summaryREptpdf')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&srprodtype=" + srprodtype;
}
*/
function defectsummaryRpt(){
     ...
     window.location = "<?php echo e(url('/defectsummaryRpt')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&ptype=" + ptype + "&&option=" + option;
}
...
/*function defectsummaryRptpdf(){
     ...
     window.location = "<?php echo e(url('/defectsummaryRptpdf')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&ptype=" + ptype + "&&option=" + option;
}
*/
function yieldsumRpt(){
     ...
     window.location = "<?php echo e(url('/yieldsumRpt')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&prodtype=" + prodtype + "&&family=" + family + "&&series=" + series + "&&device=" + device + "&&pono=" + pono;    
}
...
function yieldsumRptpdf(){
     ...
     window.location = "<?php echo e(url('/yieldsumRptpdf')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&prodtype=" + prodtype + "&&family=" + family + "&&series=" + series + "&&device=" + device + "&&pono=" + pono;    
}
...
function yieldsumfamRpt(){
     ...
     window.location = "<?php echo e(url('/yieldsumfamRpt')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&chosen=" + chose + "&&yieldtarget=" + yieldtarget + "&&ptype=" + ptype;

     // $.ajax({
     //      url: "<?php echo e(url('/yieldsumRptpdf')); ?>",
     //      method: 'get',
     //      data:  {
...
function yieldsumfamRptpdf(){
     ...
     window.location = "<?php echo e(url('/yieldsumfamRptpdf')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&chosen=" + chose;
...
function ButtonsClicked(){
     $('#btnaddnew').click(function(){
          window.location.href = "<?php echo e(url('/addnewYieldperformance')); ?>";
     });
