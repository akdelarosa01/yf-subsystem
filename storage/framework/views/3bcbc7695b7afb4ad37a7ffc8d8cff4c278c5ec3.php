...
<?php $__env->startSection('content'); ?>
	...
	<?php foreach($userProgramAccess as $access): ?>
		<?php if($access->program_code == Config::get('constants.MODULE_CODE_MRP')): ?>
			...
			<div class="col-md-12">
				...
				<div class="portlet box blue">
					...
					<div class="portlet-body">
						...
						<form method="POST" action="<?php echo e(url('/mrpreadfiles')); ?>" class="form-horizontal form-bordered" enctype="multipart/form-data" onsubmit="showLoading()">
          ...
          <div class="modal-dialog modal-sm gray-gallery">
               <div class="modal-content ">
                    ...
                    <div class="modal-footer">
                    	<a href="<?php echo e(url('/mrpexcel')); ?>" class="btn green">Download MRP File</a>
...
<?php $__env->startPush('script'); ?>
	...
	<?php if(Session::has('msg')): ?>
		<script type="text/javascript">
			var title = "<?php echo e(Session::get('msg_type')); ?>";
